...
export const ApyChart = ({
    ...
    const ticks = useMemo(() => {
        ...
        if (range === '1m')
            return unique.filter((_, i) => i % 5 === 0).map((d) => d.rawDate);
                    ...
                    {RANGE_OPTIONS.map((r) => (
                        <Button
                            ...
                            className={cn(
                                ...
                                range === r &&
                                    'border-sky-400 bg-dash-bg text-sky-400 hover:bg-dash-bg hover:text-sky-400',
                            )}
                        >
                            {r.toUpperCase()}
                        </Button>
                    ...
                    {hasData ? (
                        ...
                        >
                            ...
                            >
                                ...
                                <ChartLegend
                                    content={
                                        <ChartLegendContent className='pt-4 text-dash-muted font-bold tracking-widest text-xs' />
                                    }
                                />
