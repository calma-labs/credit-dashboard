...
function StatCard({
    ...
    return (
        <div style={{
            border: '1px solid #161d29', borderRadius: 14, padding: '16px 18px',
            background: highlight
                ? 'linear-gradient(160deg,rgba(79,227,193,.06),rgba(255,255,255,.01))'
                : 'rgba(255,255,255,.012)',
        }}>
            <div style={{ fontSize: 11.5, color: '#8B96A9', marginBottom: 8, fontWeight: 500 }}>{label}</div>
            <div style={{
                fontSize: 24, fontWeight: 700, fontFamily: "'Geist Mono', monospace",
                letterSpacing: '-0.02em', color: accent ? AC : '#EEF1F6',
            }}>{value}</div>
            <div style={{ fontSize: 11.5, color: accent ? AC : '#8B96A9', marginTop: 6, fontFamily: "'Geist Mono', monospace" }}>
                {sub}
            </div>
        </div>
    );
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#0A0E17', color: '#EEF1F6' }}>
            ...
            <header style={{
                ...
                borderBottom: '1px solid #161d29', position: 'sticky', top: 0, zIndex: 10,
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <div style={{
                            ...
                            fontWeight: 800, color: '#04140f', fontSize: 13,
                    ...
                    {/* Live indicator */}
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontFamily: "'Geist Mono', monospace", fontSize: 12, color: '#8B96A9' }}>
                        <span style={{
                            width: 7, height: 7, borderRadius: '50%', background: AC,
                    ...
                    <div style={{ display: 'flex', gap: 16, fontSize: 12.5 }}>
                        <span style={{ color: '#5C6577' }}>
                            Markets <span style={{ color: '#EEF1F6', fontFamily: "'Geist Mono', monospace", fontWeight: 600 }}>{shownCount}</span>
                        </span>
                        <span style={{ color: '#5C6577' }}>
                            TVL tracked <span style={{ color: '#EEF1F6', fontFamily: "'Geist Mono', monospace", fontWeight: 600 }}>{stats.totalTVL}</span>
                        </span>
                        <span style={{ color: '#5C6577' }}>
                            Median APY <span style={{ color: AC, fontFamily: "'Geist Mono', monospace", fontWeight: 600 }}>{stats.medianAPY}%</span>
                        </span>
                    </div>
                </div>
            </header>
            ...
            <main style={{ padding: '28px 28px 60px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 20, marginBottom: 22, flexWrap: 'wrap' }}>
                    <div>
                        <h1 style={{ margin: '0 0 6px', fontSize: 28, fontWeight: 700, letterSpacing: '-0.03em', color: '#EEF1F6' }}>
                            Markets
                        </h1>
                        <p style={{ margin: 0, fontSize: 13.5, color: '#8B96A9' }}>
                            Compare lending markets across protocols ·{' '}
                            <span style={{ color: '#c7cdd8' }}>{shownCount} shown</span>
                        </p>
                    </div>
                    <div style={{ display: 'flex', gap: 10 }}>
                        <button style={{
                            ...
                            color: '#c7cdd8', fontSize: 13, fontWeight: 500,
                    ...
                    <div style={{ position: 'relative', flex: 1, minWidth: 200, maxWidth: 320 }}>
                        ...
                        <input
                            ...
                            style={{
                                ...
                                borderRadius: 10, border: '1px solid #232c3d',
                                background: 'rgba(255,255,255,.02)', color: '#EEF1F6',
