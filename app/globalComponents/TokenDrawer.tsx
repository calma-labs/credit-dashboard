      ...
      setSnapshots(
        results
          ...
          .map((r) => ({
            ...
            protocolTotalActiveLoans:
              r.data.snapshot.protocolTotalActiveLoans ?? null,
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 12, color: "#8B96A9", marginTop: 5 }}>
              Lending Markets
            </div>
          </div>
          <button
                  ...
                  <thead>
                    <tr>
                      {[
                        ...
                        <th
                          key={h}
                          className="px-3 py-2.5 text-left text-[10px] font-semibold text-[#6b7688] font-mono tracking-wider uppercase border-b border-dash-border whitespace-nowrap"
                        >
                          {h}
                        </th>
                      ))}
                  ...
                  <tbody>
                    {snapshots.map((s) => (
                      ...
                      >
                        <td className="p-3 align-middle">
                          <span className="inline-flex items-center gap-2">
                            <span
                              ...
                              style={{
                                background:
                                  PROTOCOL_COLORS[s.protocol] ?? "#556",
                              }}
                            />
                        ...
                        <td className="p-3 align-middle font-mono text-[12.5px] font-semibold text-dash-text">
                          {s.protocolTotalActiveLoans
                            ? formatTVL(s.protocolTotalActiveLoans)
                            : "—"}
                        </td>
